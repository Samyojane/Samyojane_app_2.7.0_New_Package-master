...
public class RI_Field_Report_Caste_Certificate extends AppCompatActivity {
    ...
    TableRow TableApplicantCaste, TableCasteReservation, TableApplicantCategory;
    ...
    TextView tvVillageName, tvAppCategory, tvAppCaste, tvAnnualIncome, tvRemarksColor, tvAppCaste_VA;
    String strRemarks;
...
//        getCasteCode = Integer.parseInt(appCaste);
        ...
        if(serviceCode.equals("41"))
        {
            ...
            sqlLiteOpenHelper_class = new SqlLiteOpenHelper_Class(RI_Field_Report_Caste_Certificate.this, "samyoj","samyoj","samyoj","samyoj","samyoj");
            sqlLiteOpenHelper_class.open_Minority_Caste_Tbl();
            casteName = sqlLiteOpenHelper_class.GetMinorityCaste_BY_Code(getCasteCode);
