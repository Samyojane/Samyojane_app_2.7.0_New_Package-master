...
public class New_Request_Kan extends AppCompatActivity{
    ...
    TextView txt1, txt2, txt3, txt4, txt5, txt6, txt7, txt8, txt9, txt10, txt11, txt12, tv_IDName;
    ...
    TableRow Service6, Service67, Service678, trService10, Service10, trCatService9999, tr_casteService9999,
            trService55, trService551, trApplicantAge,  trFinYear, trCertValidity;;
    ...
    TextView tvAmount, tvAge, tvCaste, tvCategory, tvAccnumber, tvIfsc;
    String year, month;
    TextView tvYear, tvMonths, tvFinYear,tvCertVal;;
    String str;
    String lang_flag;
    String appImage=null,  finYear= null,certValidity =null;;
    ImageView iv_scst;
    String Id_Name;
    int Id_Code;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PhoneNumberUtils.formatNumber(tvRemarks.getText().toString().trim());
        ...
        sqlLiteOpenHelper_class_kan = new SqlLiteOpenHelper_Class_Kan(this,str);
        sqlLiteOpenHelper_class_kan.open_Docs_Type_Tbl();
        labelsDocs = sqlLiteOpenHelper_class_kan.GetDocsName();
...
//                + DataBaseHelperClass_RandomNum.RandomNum + ") values " + "('" + report_no + "')");
       ...
       /* autoSearchCaste.setOnTouchListener((v, event) -> {
        ...
        Log.d("New_Request_Kan", "town_code: "+town_code);
        Log.d("New_Request_Kan", "town_Name: "+town_Name);
        Log.d("New_Request_Kan", "ward_code: "+ward_code);
        Log.d("New_Request_Kan", "ward_Name: "+ward_Name);
        Log.d("New_Request_Kan","option_Flag: "+ option_Flag);

        Log.d("New_Request_Kan", "" + district_Code);
        Log.d("New_Request_Kan", "" + taluk_Code);
        Log.d("New_Request_Kan", "" + hobli_Code);
        Log.d("New_Request_Kan", "" + village_name);
...
//            }
        ...
        if (cursor.getCount() > 0) {
            if (cursor.moveToFirst()) {
                ...
                if(address3 == null || address3.isEmpty()|| address3.equals(" "))
                {
                    address3 = "NA";
                }
        ...
        switch (serviceCode) {
            ...
            case "37":{
                ...
                Log.d("get_Value", "" + etAnnualIncome.getText().toString());
            ...
            case "41":
                ...
                sqlLiteOpenHelper_class_kan = new SqlLiteOpenHelper_Class_Kan(New_Request_Kan.this, "samyoj","samyoj","samyoj","samyoj");
                sqlLiteOpenHelper_class_kan.open_Minority_Caste_Tbl();
                caste_name = sqlLiteOpenHelper_class_kan.GetMinorityCaste_BY_Code(getCasteCode);
            ...
            case "55": {
                ...
                if (cursor6.getCount() > 0) {
                    if (cursor6.moveToFirst()) {
                        ...
                        appAge = cursor6.getString(cursor6.getColumnIndexOrThrow(DataBaseHelperClass_btnDownload_ServiceTranTable.ApplicantAge));
        ...
        gpsTracker = new GPSTracker(getApplicationContext(), New_Request_Kan.this);
        ...
        radioGroupA.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            if (checkedId == R.id.radioButton1A) {
                ...
                optionA = "N";
                Log.d("optionA", "" + optionA);
                Intent i13 = new Intent(New_Request_Kan.this, New_Request_SecondScreen.class);
        ...
        btnUploadDocs.setOnClickListener(v -> {
            ...
            {
                cursorDoc.close();
                Toast.makeText(New_Request_Kan.this,"Only 3 documents are allowed to upload",Toast.LENGTH_LONG).show();
            }
        });

        btnViewUploadDocs.setOnClickListener(v -> {
            Intent i11 = new Intent(New_Request_Kan.this, ViewUploadedDocs.class);
        ...
        btnReport.setOnClickListener(v -> {
            ...
            if (latitude != 0.0 && longitude != 0.0) {
                ...
                runOnUiThread(() -> {
                    AlertDialog.Builder dialog = new AlertDialog.Builder(New_Request_Kan.this);
...
//            int imgPos = parent.getItemAtPosition(id);
            Log.d("Selected_Item", "" + strImageName);
            sqlLiteOpenHelper_class_kan = new SqlLiteOpenHelper_Class_Kan(this,str);
            sqlLiteOpenHelper_class_kan.open_Docs_Type_Tbl();
//            String getImageName = sqlLiteOpenHelper_class.GetDocs_BY_Code();
            getImageCode = sqlLiteOpenHelper_class_kan.GetDocsCode(strImageName);
    ...
    public void saveDocImages_DB(String pdfInString) {
        DataBaseHelperClass_btnUpload_Docs openHelper = new DataBaseHelperClass_btnUpload_Docs(New_Request_Kan.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(New_Request_Kan.this, New_Request_FirstScreen.class);
                ...
                .addOnFailureListener(
                        new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                runOnUiThread(()->
                                {
                                    Toast.makeText(New_Request_Kan.this,"Please do not capture the blank image",Toast.LENGTH_LONG).show();
                                });
                            }
