...
public class New_Request_Resident_Parameters_Kan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openHelper = new DataBaseHelperClass_btnDownload_ServiceTranTable(New_Request_Resident_Parameters_Kan.this);
            ...
            try {
                ...
                if (latitude != 0.0 && longitude != 0.0) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        AlertDialog.Builder dialog = new AlertDialog.Builder(New_Request_Resident_Parameters_Kan.this);
    ...
    public String StoreData_in_DB() {
        ...
        if (cursor.getCount() > 0) {
            try {
                ...
                Intent i = new Intent(New_Request_Resident_Parameters_Kan.this, New_Request_FirstScreen.class);
    ...
    public void truncateDatabase_Docs(){
        ...
        openHelper = new DataBaseHelperClass_btnDownload_Docs(New_Request_Resident_Parameters_Kan.this);
        database = openHelper.getWritableDatabase();
    ...
    private  void buildAlertMessageGoingBack() {
        ...
        builder.setMessage("Are you sure?\nDo you want to Discard the changes")
                .setCancelable(false)
                .setPositiveButton(getString(R.string.yes), (dialog, id) -> {
                    New_Request_Resident_Parameters_Kan.super.onBackPressed();
                    Intent i = new Intent(New_Request_Resident_Parameters_Kan.this, New_Request_FirstScreen.class);
                    i.putExtra("applicant_Id", applicant_Id);
                    i.putExtra("district_Code", district_Code);
                    i.putExtra("taluk_Code", taluk_Code);
