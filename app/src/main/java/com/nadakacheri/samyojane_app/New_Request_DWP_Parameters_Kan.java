...
public class New_Request_DWP_Parameters_Kan extends AppCompatActivity {

    TextView applicant_infor;
    TextView tvHobli, tvTaluk, tvVA_Name, tvServiceName, tvError;
    ...
    EditText etDeathDate,etHusRegNo,etRemarks;
    ...
    String str, strDeathDate, strHusRegNo, strRemarks;
...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_request_dwp_parameters);
        ...
        etHusRegNo= findViewById(R.id.etHusRegNo);
        ...
        etDeathDate.setFocusable(false);
        etDeathDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDateDialog(etDeathDate);
            }
        });
        ...
        btnSave.setOnClickListener(v -> {
            try {
                ...
                strDeathDate = etDeathDate.getText().toString().trim();
                strHusRegNo = etHusRegNo.getText().toString().trim();
                strRemarks = etRemarks.getText().toString().trim();
                Log.d("DeathDate", "" + strDeathDate);
                Log.d("Husband Death Reg. no", "" + strHusRegNo);
                Log.d("Remarks", "" + strRemarks);

                if (latitude != 0.0 && longitude != 0.0) {
                    if(store!=null) {
                        if (gender.contains("female")) {
                            if (!TextUtils.isEmpty(strDeathDate)) {
                                if (!TextUtils.isEmpty(strHusRegNo)) {
                                    ...
                                    etHusRegNo.setError(getString(R.string.field_canno_null));
                                }
                            } else {
                                etDeathDate.setError(getString(R.string.field_canno_null));
                            }
                        }else {
                                Toast.makeText(New_Request_DWP_Parameters_Kan.this,
                                        "Please capture female beneficaiary photo",
                    ...
                    runOnUiThread(() -> {
                        ...
                        AlertDialog.Builder dialog = new AlertDialog.Builder(New_Request_DWP_Parameters_Kan.this);
    ...
    private void showDateDialog(final EditText etDeathDate) {
        ...
        DatePickerDialog.OnDateSetListener dateSetListener=new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                etDeathDate.setText(simpleDateFormat.format(calendar.getTime()));

            }
        };

        new DatePickerDialog(New_Request_DWP_Parameters_Kan.this,dateSetListener,calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH),calendar.get(Calendar.DAY_OF_MONTH)).show();
    }
    ...
    public void truncateDatabase_Docs(){
        ...
        openHelper = new DataBaseHelperClass_btnDownload_Docs(New_Request_DWP_Parameters_Kan.this);
    ...
    public String StoreData_in_DB(){
        ...
        openHelper = new DataBaseHelperClass_btnDownload_ServiceTranTable(New_Request_DWP_Parameters_Kan.this);
        database = openHelper.getWritableDatabase();
...
//                        + DataBaseHelperClass_btnDownload_ServiceTranTable.UPD_Attested_Address + "='" + option2 + "',"
                ...
                Intent i = new Intent(New_Request_DWP_Parameters_Kan.this, New_Request_FirstScreen.class);
    ...
    private  void buildAlertMessageGoingBack() {
        ...
        builder.setMessage(getString(R.string.discard_changes))
                .setCancelable(false)
                .setPositiveButton(getString(R.string.yes), (dialog, id) -> {
                    New_Request_DWP_Parameters_Kan.super.onBackPressed();
                    Intent i = new Intent(New_Request_DWP_Parameters_Kan.this, New_Request_FirstScreen.class);
                    i.putExtra("applicant_Id", applicant_Id);
                    i.putExtra("district_Code", district_Code);
                    i.putExtra("taluk_Code", taluk_Code);
