...
public class New_Request_DWP_Parameters extends AppCompatActivity {
...
//        }
                ...
                if (latitude != 0.0 && longitude != 0.0) {
                    if(store!=null) {
                        if (gender.contains("female")) {
                            ...
                            Toast.makeText(New_Request_DWP_Parameters.this,
                    ...
                    runOnUiThread(() -> {
                        ...
                        AlertDialog.Builder dialog = new AlertDialog.Builder(New_Request_DWP_Parameters.this);
    ...
    private void showDateDialog(final EditText etDeathDate) {
        ...
        new DatePickerDialog(New_Request_DWP_Parameters.this,dateSetListener,calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH),calendar.get(Calendar.DAY_OF_MONTH)).show();
    }
    ...
    public void truncateDatabase_Docs(){
        ...
        openHelper = new DataBaseHelperClass_btnDownload_Docs(New_Request_DWP_Parameters.this);
    ...
    public String StoreData_in_DB(){
        ...
        openHelper = new DataBaseHelperClass_btnDownload_ServiceTranTable(New_Request_DWP_Parameters.this);
        database = openHelper.getWritableDatabase();
...
//                        + DataBaseHelperClass_btnDownload_ServiceTranTable.UPD_Attested_Address + "='" + option2 + "',"
                ...
                Intent i = new Intent(New_Request_DWP_Parameters.this, New_Request_FirstScreen.class);
    ...
    private  void buildAlertMessageGoingBack() {
        ...
        builder.setMessage(getString(R.string.discard_changes))
                .setCancelable(false)
                .setPositiveButton(getString(R.string.yes), (dialog, id) -> {
                    New_Request_DWP_Parameters.super.onBackPressed();
                    Intent i = new Intent(New_Request_DWP_Parameters.this, New_Request_FirstScreen.class);
                    i.putExtra("applicant_Id", applicant_Id);
                    i.putExtra("district_Code", district_Code);
                    i.putExtra("taluk_Code", taluk_Code);
