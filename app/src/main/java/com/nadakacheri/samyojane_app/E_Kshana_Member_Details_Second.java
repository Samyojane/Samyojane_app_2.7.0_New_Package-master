...
public class E_Kshana_Member_Details_Second extends AppCompatActivity {
    ...
    String str_add1=null, address1_Eng=null, str_add2=null, address2_Eng=null, str_add3=null, address3_Eng=null, pincode=null,
            dob=null, genderName=null, mobile=null, income=null, remarks=null, residingYear=null;
    int Age=0;
    String uName_get;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        datePickerDialog = new DatePickerDialog(E_Kshana_Member_Details_Second.this, date, myCalendar
...
//                    myCalendar.get(Calendar.DAY_OF_MONTH)).show();
        ...
        sqlLiteOpenHelper_class_kan = new SqlLiteOpenHelper_Class_Kan(E_Kshana_Member_Details_Second.this);
        sqlLiteOpenHelper_class_kan.open_Reasons_Master_Tbl();

        sqLiteAssetHelper_masters = new SQLiteAssetHelper_Masters(E_Kshana_Member_Details_Second.this);
                                                                                        ...
                                                                                        call.enqueue(new Callback<String>() {
                                                                                            ...
                                                                                            public void onResponse(Call<String> call, Response<String> response) {
                                                                                                ...
                                                                                                if (multipleResource.equals("success")) {
                                                                                                    ...
                                                                                                    Intent i = new Intent(E_Kshana_Member_Details_Second.this, E_Kshana_MainScreen.class);
                                                                                            ...
                                                                                            call.enqueue(new Callback<String>() {
                                                                                                ...
                                                                                                public void onResponse(Call<String> call, Response<String> response) {
                                                                                                    ...
                                                                                                    try {
                                                                                                        ...
                                                                                                        runOnUiThread(runnable);
                                                                                                        e.printStackTrace();
                                                                                                        runOnUiThread(() -> Toast.makeText(getApplicationContext(), getString(R.string.server_exception), Toast.LENGTH_SHORT).show());                                                                                      Log.e("NullPointerException", "" + e.getMessage());
                                                                                                    }
                                                                                                }
