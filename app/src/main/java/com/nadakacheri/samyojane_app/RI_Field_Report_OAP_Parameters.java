...
public class RI_Field_Report_OAP_Parameters extends AppCompatActivity {
...
//        txt_raiseLoc.setText(raisedLoc);
...
//        tv_IDName.setText(Id_Name);
        ...
        btnSave.setOnClickListener(v -> {
            try {
                ...
                if (latitude != 0.0 && longitude != 0.0) {
                                                                                                ...
                                                                                                if (TextUtils.isEmpty(strDeptAmount)) {
                                                                                                    ...
                                                                                                    if (amount_len >= 4 && amount_Value >= 1000) {
                                                                                                        if (TextUtils.isEmpty(strRemarks) && !strRemarks.matches(space_restriction) ) {
                                                                                                            ...
                                                                                                            openHelper = new DataBaseHelperClass_btnDownload_ServiceTranTable(RI_Field_Report_OAP_Parameters.this);
                                                                                                            database = openHelper.getWritableDatabase();
                    ...
                    runOnUiThread(() -> {
                        AlertDialog.Builder dialog = new AlertDialog.Builder(RI_Field_Report_OAP_Parameters.this);
    ...
    public String StoreData_in_DB() {
        ...
        openHelper = new DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI(RI_Field_Report_OAP_Parameters.this);
        database = openHelper.getWritableDatabase();
        ...
        if (cursor.getCount() > 0) {
            try {
                ...
                Intent i = new Intent(RI_Field_Report_OAP_Parameters.this, RI_Field_Report_FirstScreen.class);
    ...
    private void showDateDialog(final EditText etDate) {
        ...
        new DatePickerDialog(RI_Field_Report_OAP_Parameters.this, dateSetListener, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
    }
    ...
    private void buildAlertMessageGoingBack() {
        ...
        builder.setMessage(getString(R.string.discard_changes))
                .setCancelable(false)
                .setPositiveButton(getString(R.string.yes), (dialog, id) -> {
                    RI_Field_Report_OAP_Parameters.super.onBackPressed();
                    Intent i = new Intent(RI_Field_Report_OAP_Parameters.this, RI_Field_Report_FirstScreen.class);
                    i.putExtra("applicant_Id", applicant_Id);
                    i.putExtra("district_Code", district_Code);
                    i.putExtra("taluk_Code", taluk_Code);
