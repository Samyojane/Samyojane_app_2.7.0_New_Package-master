...
public class New_Request_OAP_Parameters_Kan extends AppCompatActivity {
    ...
    Spinner spinnerDept;
    ImageView imageView;
    ArrayAdapter<CharSequence> adapter_Dept;
    String strDeptName,strScheme,strDeptAmount;
    ...
    String strRemarks,strDate;
    int income_len, income_Value;
    GPSTracker gpsTracker;
    double latitude, longitude;
    int getDeptCode ;
    AppCompatActivity activity;
    String str,strIncome;
...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new__request__oap__parameters__kan);
                ...
                if (latitude != 0.0 && longitude != 0.0) {
                    if(option.equals("Y")){
                        if(!strDeptName.equals(getString(R.string.select_Dept_spinner))){
                            ...
                            Toast.makeText(getApplicationContext(), getString(R.string.select_department), Toast.LENGTH_SHORT).show();
                        }
                    }else{
                        if (TextUtils.isEmpty(strRemarks)) {
                            etRemarks.setError(getString(R.string.field_canno_null));
                    ...
                    runOnUiThread(() -> {
                        ...
                        AlertDialog.Builder dialog = new AlertDialog.Builder(New_Request_OAP_Parameters_Kan.this);
    ...
    private void showDateDialog(final EditText etDate) {
        ...
        new DatePickerDialog(New_Request_OAP_Parameters_Kan.this,dateSetListener,calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH),calendar.get(Calendar.DAY_OF_MONTH)).show();
    }


    public void truncateDatabase_Docs(){
        //dialog1.setProgress(20);
        openHelper = new DataBaseHelperClass_btnDownload_Docs(New_Request_OAP_Parameters_Kan.this);
    ...
    public String StoreData_in_DB(){
        ...
        openHelper = new DataBaseHelperClass_btnDownload_ServiceTranTable(New_Request_OAP_Parameters_Kan.this);
        database = openHelper.getWritableDatabase();
        ...
        if (cursor.getCount() > 0) {
            try {
                ...
                Intent i = new Intent(New_Request_OAP_Parameters_Kan.this, New_Request_FirstScreen.class);
    ...
    private  void buildAlertMessageGoingBack() {
        ...
        builder.setMessage(getString(R.string.discard_changes))
                .setCancelable(false)
                .setPositiveButton(getString(R.string.yes), (dialog, id) -> {
                    New_Request_OAP_Parameters_Kan.super.onBackPressed();
                    Intent i = new Intent(New_Request_OAP_Parameters_Kan.this, New_Request_FirstScreen.class);
                    i.putExtra("applicant_Id", applicant_Id);
                    i.putExtra("district_Code", district_Code);
                    i.putExtra("taluk_Code", taluk_Code);
