...
/**
 * Created by Nischitha on 29,December,2021
 **/
public class New_Request_CasteCertificate_Kan extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sqlLiteOpenHelper_class_kan = new SqlLiteOpenHelper_Class_Kan(New_Request_CasteCertificate_Kan.this);
        ...
        }else if("41".equals(serviceCode))
        {
            ...
            sqlLiteOpenHelper_class_kan = new SqlLiteOpenHelper_Class_Kan(New_Request_CasteCertificate_Kan.this, "samyoj","samyoj","samyoj","samyoj");
            sqlLiteOpenHelper_class_kan.open_Minority_Caste_Tbl();
            strSearchCaste = sqlLiteOpenHelper_class_kan.GetMinorityCaste_BY_Code(getCasteCode);
    ...
    public void saveService_9_and_6(){
        if(latitude!=0.0 && longitude!=0.0) {
            ...
            runOnUiThread(() -> {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(New_Request_CasteCertificate_Kan.this);
    ...
    public void truncateDatabase_Docs(){
        ...
        openHelper = new DataBaseHelperClass_btnDownload_Docs(New_Request_CasteCertificate_Kan.this);
        database = openHelper.getWritableDatabase();
    ...
    public String StoreData_in_DB(){
        ...
        if (cursor.getCount() > 0) {
            try {
                ...
                Intent i = new Intent(New_Request_CasteCertificate_Kan.this, New_Request_FirstScreen.class);
