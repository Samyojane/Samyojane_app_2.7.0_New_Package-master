...
public class RI_Field_Report_caste_income_parameters_Kan  extends AppCompatActivity {
    ...
    String village_name, service_name, casteOther;
    ...
    String option, option2, option3, appAnnualIncomeVA;
    ...
    TextView tvVillageName, tvAppCategory, tvAppCaste, tvCreamyLayer, tvReasonForCreamyLayer, tvAnnualIncome, tvRemarksColor,tvAnnualIncomeVA, AnnualIncomeVA;
    String strRemarks;
    ...
    @SuppressLint({"SetTextI18n", "ClickableViewAccessibility", "HardwareIds", "Range"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAnnualIncomeVA = findViewById(R.id.tvAnnualIncome_va);
...
//        getCasteCode = Integer.parseInt(appCaste);
        ...
        tvAnnualIncomeVA.setText(appAnnualIncomeVA);
        ...
        radioGroup2.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            if (checkedId == R.id.radioButton3) {
                ...
                ReservationGiven.setVisibility(View.VISIBLE);
                AnnualIncome.setVisibility(View.VISIBLE);
                tvAnnualIncomeVA.setVisibility(View.VISIBLE);
                TableCasteReservation.setVisibility(View.VISIBLE);
                tr_creamyLayer.setVisibility(View.GONE);
                tr_reasonForCreamyLayer.setVisibility(View.GONE);
                ...
                tvAnnualIncomeVA.setVisibility(View.GONE);
            ...
            try {
                ...
                if (latitude != 0.0 && longitude != 0.0) {
                    ...
                    if (option2.equals("N")) {
                        ...
                        else if (serviceCode.equals("11") || serviceCode.equals("34") || serviceCode.equals("37")|| Objects.equals(serviceCode,"27")) {
        ...
        if(cursor.getCount()>0){
            try {
                ...
                database.execSQL("update " + DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.TABLE_NAME_1 + " set "
                        ...
                        + DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.CST_Caste_Desc_AsPer_VA + "='NULL',"
