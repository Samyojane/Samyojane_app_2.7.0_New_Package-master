...
public class RI_Field_Report_caste_income_parameters extends AppCompatActivity {
    ...
    String RI_Name,district, taluk, hobli, VA_Circle_Name, VA_Name, applicant_Id, applicant_name,otherCasteData;
    ...
    TextView txt_raiseLoc, title, RI_Recommendation, ApplicantID, ApplicantName, txt_add1, txt_add2, txt_add3, txt_add_Pin, ApplicantCategory, ApplicantCaste, AnnualIncome, ReservationGiven, Remarks, tvCasteOthers,txtOthers;
    ...
    TableRow TableApplicantCategory, TableApplicantCaste, TableCasteReservation, tr_creamyLayer, tr_reasonForCreamyLayer,trAnnualIncome, trAnnualIcomeRI, ewsCaste;
    EditText tvIncome, tvRemarks,tvIncome_ri, etOtherCaste;
    int income_len, income_Value;
    String strReason, strCategory, strSearchCaste, casteOther;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(cursor.getCount()>0){
            if(cursor.moveToFirst()){
                ...
                }else if(serviceCode.equals("43"))
                {
                    ...
                    casteOther = cursor.getString(cursor.getColumnIndexOrThrow(DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.CST_Caste_Desc_AsPer_VA));
        ...
        if(serviceCode.equals("43")) {
            if (casteOther.equals("null")) {
                ewsCaste.setVisibility(View.GONE);
            } else {
                tvCasteOthers.setText(casteOther);
                ewsCaste.setVisibility(View.VISIBLE);
            }
        }
        ...
        radioGroup2.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            if (checkedId == R.id.radioButton3) {
                ...
                if (serviceCode.equals("43") && !casteOther.equals("null")){
                        tvCasteOthers.setVisibility(View.VISIBLE);
                        tvCasteOthers.setText(casteOther);
                    }
                ...
                if (serviceCode.equals("43")){
                    ...
                    {
                        ewsCaste.setVisibility(View.VISIBLE);
                        etOtherCaste.setVisibility(View.VISIBLE);
                        tvCasteOthers.setVisibility(View.GONE);
                    }
                ...
                txtOthers.setTextColor(Color.parseColor("#0000ff"));
                ...
                if (latitude != 0.0 && longitude != 0.0) {
                    ...
                    if (option2.equals("N")) {
                        ...
                        if (Objects.equals(serviceCode, "6")) {
                            ...
                            tvCasteOthers.setText(etOtherCaste.getText().toString());
                            ...
                            if(!casteOther.equals("null"))
                            {
                                otherCasteData = tvCasteOthers.getText().toString().trim();
                                sqlLiteOpenHelper_class = new SqlLiteOpenHelper_Class();
                                sqlLiteOpenHelper_class.open_Cat_Caste_Tbl();
                                exists = sqlLiteOpenHelper_class.GetCheckCaste(otherCasteData);
                            }else if(!tvCasteOthers.getText().toString().trim().isEmpty()){
                                otherCasteData = tvCasteOthers.getText().toString().trim();
                                sqlLiteOpenHelper_class = new SqlLiteOpenHelper_Class();
                                sqlLiteOpenHelper_class.open_Cat_Caste_Tbl();
                                exists = sqlLiteOpenHelper_class.GetCheckCaste(otherCasteData);
        ...
        if (!strSearchCaste.equals(getString(R.string.select_caste_spinner))) {
            if (getCasteCode!=0) {
                if (getCasteCode == 9999) {
                    if (!TextUtils.isEmpty(otherCasteData) || otherCasteData != null || !tvCasteOthers.getText().toString().trim().isEmpty()
                            || !TextUtils.isEmpty(tvCasteOthers.getText().toString().trim())) {
                        if (!exists) {
                            if (option.equals("N")) {
                                if (!strReason.equals(getString(R.string.reason_spinner))) {
                                    if (TextUtils.isEmpty(strIncome)) {
                            ...
                            tvCasteOthers.setError("Caste already exists. Please select it");
                        }
                    } else {
                        tvCasteOthers.setError("Please enter caste");
                    }
        ...
        if(cursor.getCount()>0) {
            try {
                ...
                database.execSQL("update " + DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.TABLE_NAME_1 + " set "
                        ...
                        + DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.CST_Caste_Desc_AsPer_VA + "='" + casteOther + "',"
        ...
        if(cursor.getCount()>0){
            try {
                ...
                database.execSQL("update " + DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.TABLE_NAME_1 + " set "
                        ...
                        + DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.UPD_DifferFromAppinformation + "='" + option2 + "',"
                        + DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.UPD_Report_No + "='" + report_no + "',"
                        + DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.CST_Caste_Desc_AsPer_VA + "='" + otherCasteData + "',"
                        + DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.UPD_ReportDate + "='" + currDate + "',"
                        + DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.UPD_DataUpdateFlag + "=1"
                        + " where " + DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI.UPD_GSCNo + "='" + applicant_Id + "'");
    ...
    public void GetCaste_EWS(){
        ...
        autoSearchCaste.setOnItemClickListener((parent, view, position, id) -> {
           ...
           // CatCode = ((SpinnerObject)parent.getItemAtPosition(position)).getId();
            ...
            sqlLiteOpenHelper_class = new SqlLiteOpenHelper_Class();
            sqlLiteOpenHelper_class.open_Cat_Caste_Tbl();
            getCasteCode = sqlLiteOpenHelper_class.GetCasteCode(strSearchCaste, appCategory);
            Log.d("Selected_casteCode", "getCatCode = "+ appCategory +", getCasteCode = "+ getCasteCode);
            if(getCasteCode == 9999)
            {
                ewsCaste.setVisibility(View.VISIBLE);
                etOtherCaste.setVisibility(View.VISIBLE);
    ...
    public class GetEWSCategorySelected implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            strCategory = ((SpinnerObject) spCategory.getSelectedItem()).getValue();
            ApplicantCategory.setText(strCategory);
            Log.d("Selected_Item1", ""+strCategory);
            sqlLiteOpenHelper_class = new SqlLiteOpenHelper_Class();
            sqlLiteOpenHelper_class.open_Cat_Caste_Tbl();
            appCategory = sqlLiteOpenHelper_class.GetCategoryCode(strCategory);
