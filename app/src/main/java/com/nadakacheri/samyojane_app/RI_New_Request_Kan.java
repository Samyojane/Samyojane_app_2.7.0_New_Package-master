...
public class RI_New_Request_Kan extends AppCompatActivity {
    ...
    TextView tvVillageName, tvAppCategory, tvAppCaste, tvAnnualIncome, txt_appAge,tvAccnumber,tvIfsc;
    String strRemarks;
...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (serviceCode.matches("12") || serviceCode.matches("17") || serviceCode.matches("19") ||
                ...
                ||serviceCode.matches("61")||serviceCode.matches("57")||serviceCode.matches("56")
...
//        getCasteCode = Integer.parseInt(appCaste);
        ...
        radioGroup1.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            if (checkedId == R.id.radioButton1) {
                ...
                Intent i13 = new Intent(RI_New_Request_Kan.this, RI_Field_Report_OAP_Parameters_Kan.class);
        ...
        btnDownDocs.setOnClickListener(v -> {
            if (isNetworkAvailable()) {
                ...
                openHelper = new DataBaseHelperClass_btnDownload_Docs(RI_New_Request_Kan.this);
                database = openHelper.getWritableDatabase();
        ...
        btnViewDocs.setOnClickListener(v -> {
            Intent i12 = new Intent(RI_New_Request_Kan.this, View_Docs.class);
            ...
            try {
                ...
                if (latitude != 0.0 && longitude != 0.0) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        AlertDialog.Builder dialog = new AlertDialog.Builder(RI_New_Request_Kan.this);
    ...
    public String StoreData_in_DB(){
        ...
        openHelper = new DataBaseHelperClass_btnDownload_ServiceParameter_Tbl_RI(RI_New_Request_Kan.this);
        database = openHelper.getWritableDatabase();
        ...
        if(cursor.getCount()>0){
            try {
                ...
                Intent i = new Intent(RI_New_Request_Kan.this, RI_Field_Report_FirstScreen.class);
    ...
    private void buildAlertMessageGoingBack() {
        ...
        builder.setMessage(getString(R.string.discard_changes))
                .setCancelable(false)
                .setPositiveButton(getString(R.string.yes), (dialog, id) -> {
                    RI_New_Request_Kan.super.onBackPressed();
                    Intent i = new Intent(RI_New_Request_Kan.this, RI_Field_Report_FirstScreen.class);
                    i.putExtra("applicant_Id", applicant_Id);
                    i.putExtra("district_Code", district_Code);
                    i.putExtra("taluk_Code", taluk_Code);
