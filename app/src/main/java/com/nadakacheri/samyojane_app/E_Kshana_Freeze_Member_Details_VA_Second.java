...
public class E_Kshana_Freeze_Member_Details_VA_Second extends AppCompatActivity {
    ...
    String dob=null, age=null, genderName=null, mobile=null, remarks=null, religionName;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnUpload.setOnClickListener(v -> {
            ...
            if (!TextUtils.isEmpty(age)){
                                            ...
                                            if (!TextUtils.isEmpty(remarks)) {
                                                if (isNetworkAvailable()) {
                                                    if (nameFlag.equals("Success")) {
                                                            ...
                                                            public void onResponse(Call<String> call, Response<String> response) {
                                                                ...
                                                                try {
                                                                    if (multipleResource.equals("success") && multipleResource != null && !multipleResource.equals("0")) {
                                                                        ...
                                                                        Intent i1 = new Intent(E_Kshana_Freeze_Member_Details_VA_Second.this, E_Kshana_MainScreen_VA.class);
                                                        ...
                                                        new E_Kshana_Freeze_Member_Details_VA_Second.GetEngName().execute();
                ...
                etDOB.setError(getString(R.string.enter_age));
            }
    ...
    private  void buildAlert_Back() {
        ...
        builder.setTitle("Alert")
                ...
                .setPositiveButton("YES", (dialog, id) -> {
                    Intent i1 = new Intent(this, E_Kshana_MainScreen_VA.class);
                    i1.putExtra("rc_num", rc_num);
                    i1.putExtra("districtCode", distCode_ass);
                    i1.putExtra("talukCode", talCode_ass);
                    i1.putExtra("hobliCode", hobCode_ass);
